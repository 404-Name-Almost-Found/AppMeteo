...
document.addEventListener("DOMContentLoaded",function(){
    ...
    const URLMeteo="https://api.open-meteo.com/v1/forecast?latitude="+urlParams.get("lat")+"&longitude="+urlParams.get("lon")+"&daily=weather_code,sunrise,sunset,temperature_2m_max,temperature_2m_min&hourly=weather_code,temperature_2m,cloud_cover,cloud_cover_low,cloud_cover_mid,cloud_cover_high,wind_speed_10m,precipitation&current=weather_code,temperature_2m,wind_speed_10m,relative_humidity_2m,is_day,rain,cloud_cover,is_day&utm_source=chatgpt.com"
    fetch(URLMeteo)
        ...
        .then(meteo =>{
            ...
            if (meteo.current.time === getFormattedDate()){
                ...
                tempMaxMinVento.innerHTML="Max: "+meteo.daily.temperature_2m_max[0]+"°C - Min: "+meteo.daily.temperature_2m_min[0]+"°C"+" - Vento: "+meteo.current.wind_speed_10m+" km/h"
            }
            else{
                temperaturaAttuale.innerHTML=meteo.hourly.temperature_2m[indiceOra]+"°C"
                weatherCode=meteo.hourly.weather_code[indiceOra]
                tempMaxMinVento.innerHTML="Max: "+meteo.daily.temperature_2m_max[0]+"°C - Min: "+meteo.daily.temperature_2m_min[0]+"°C"+" - Vento: "+meteo.hourly.wind_speed_10m[indiceOra]+" km/h"
